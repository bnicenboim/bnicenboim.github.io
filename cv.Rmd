...
BibOptions(check.entries = FALSE, style = "html", cite.style = "authortitle",
           bib.style = "authoryear",sorting="ydnt",max.names =10,dashed=FALSE, no.print.fields=c("doi","issn","eprint","url","customa","customb","customc"))
...
------------------------  -----------------------------------------------------------------------
2020                      "Introduction to computational Bayesian methods using Stan", with Shravan Vasishth 
...
2019                      "Advanced Bayesian methods",
...
------------------------  -----------------------------------------------------------------------
2020 (Spring)             **Lecturer** in "Methodology for Premasters Data Science & Society". Tilburg University
...
# Open software 
-  -------------------------------------------
\* [eeguana](https://bnicenboim.github.io/eeguana/). An R package for flexible manipulation of EEG data .
-  -------------------------------------------
