...
about:
  ...
  links:
    - text: "{{< ai google-scholar >}}"
      href: https://scholar.google.com/citations?user=v31PY0QAAAAJ&hl=en&oi=ao
    - text: "{{< ai semantic-scholar >}}"
      href: https://www.semanticscholar.org/author/Bruno-Nicenboim/3474855   
    - icon: github
      href: https://github.com/bnicenboim/
    - text: "{{< ai orcid >}}"
      href: http://orcid.org/0000-0002-5176-3943
    - text: "![](icons/osf.svg){height=1em style='vertical-align: -0.125em;'}"
      href: https://osf.io/cmist/#!
    - icon: linkedin
      href: https://www.linkedin.com/in/bruno-nicenboim-518763387/
---
...
-   [Introduction to Bayesian Data Analysis for Cognitive Science](https://bruno.nicenboim.me/bayescogsci) , co-authored with [Shravan Vasishth](http://www.ling.uni-potsdam.de/~vasishth/) and [Daniel Schad](https://danielschad.github.io/). You can [[buy it]](https://www.taylorfrancis.com/books/mono/10.1201/9780429342646/introduction-bayesian-data-analysis-cognitive-science-shravan-vasishth-bruno-nicenboim-daniel-schad) or [[read it for free]](https://bruno.nicenboim.me/bayescogsci).
...
-   Our book on [Introduction to Bayesian Data Analysis for Cognitive Science](https://bruno.nicenboim.me/bayescogsci) , co-authored with [Shravan Vasishth](http://www.ling.uni-potsdam.de/~vasishth/) and [Daniel Schad](https://danielschad.github.io/) has been published!! You can buy it [here](https://www.taylorfrancis.com/books/mono/10.1201/9780429342646/introduction-bayesian-data-analysis-cognitive-science-shravan-vasishth-bruno-nicenboim-daniel-schad) or read for free [here](https://bruno.nicenboim.me/bayescogsci).

<!-- -   A new recurring meeting on computational psycholinguistics, co-organized with [Jakub Dotlačil](https://www.jakubdotlacil.com/), [Lena Jäger](https://www.cl.uzh.ch/en/research-groups/digital-linguistics/people/group-leader/jaeger.html), and me, will take place in Utrecht on December 18–19, 2025. **Deadline is over**, but you can still register for the conference. More details on the [official website](https://cpl2025.sites.uu.nl/). -->
